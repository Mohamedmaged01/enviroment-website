        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
			...
			<div>
				...
				<p className="text-gray-400 leading-relaxed mb-6 mt-6">
					We are a leading Saudi environmental consultancy firm, driven by the belief that sustainability is not a choice—it is a responsibility. We empower our partners to achieve full environmental compliance through integrated, innovative, and practical solutions rooted in deep regulatory knowledge and extensive experience across industries—from energy and industry to urban development and tourism.
				</p>
			</div>
          {/* Menu Section */}
          <div>
			...
			<div>
				...
				<div className="space-y-6 mt-6">
					<div className="flex items-start gap-3">
						...
						<div>
							<h4 className="text-white font-semibold mb-1">Have any questions?</h4>
							<p className="text-gray-400 text-sm leading-relaxed">+966556395674</p>
						</div>
					</div>
					<div className="flex items-start gap-3">
						<Phone className="w-5 h-5 text-teal-500 shrink-0 mt-1" />
						<div>
							<h4 className="text-white font-semibold mb-1">Landline phone</h4>
							<p className="text-gray-400 text-sm leading-relaxed">+966126144414</p>
						</div>
					</div>
					<div className="flex items-center gap-3">
						<Mail className="w-5 h-5 text-teal-500 shrink-0" />
						<div>
							<h4 className="text-white font-semibold mb-1">Write a email</h4>
							<a
					...
					<div className="flex items-start gap-3">
						...
						<div>
							<h4 className="text-white font-semibold mb-1">Visit our location</h4>
							<p className="text-gray-400 text-sm leading-relaxed">Saudi Arabia - Jeddah</p>
						</div>
					</div>
				</div>
			</div>
